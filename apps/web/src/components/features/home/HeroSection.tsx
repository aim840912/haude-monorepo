...
export function HeroSection({ images, scrollY, currentSlide, onSlideChange }: HeroSectionProps) {
  ...
  // 當進度達到 100% 時切換幻燈片（分離 state 更新避免渲染警告）
  useEffect(() => {
    if (progress >= 100) {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center text-center pt-16 overflow-hidden">
      ...
      >
        {/* 品牌副標 */}
        <p className="text-sm md:text-base text-white/80 mb-4 tracking-[0.3em] uppercase">
          高山茶專賣店
        </p>
        ...
        {/* Slogan */}
        <p className="text-lg md:text-2xl text-white/95 mb-10 max-w-3xl mx-auto drop-shadow-md leading-relaxed">
          簡單一杯茶，不簡單的百年傳承
          <br />
