...
export const SETTING_KEYS = {
  ...
  HOME_BRAND_STORY_IMAGE: 'home.brand_story_image',
  ABOUT_HERO_IMAGE: 'about.hero_image',
  ABOUT_STORY_IMAGE_1: 'about.story_image_1',
  ABOUT_STORY_IMAGE_2: 'about.story_image_2',
  NEWS_HERO_IMAGE: 'news.hero_image',
