...
export class CreateFarmTourImageDto {
  @ApiProperty({ description: '圖片 URL', example: 'https://example.com/image.jpg' })
  @IsUrl()
  storageUrl: string;

  @ApiProperty({ description: '儲存路徑', example: 'farm-tours/abc123/image.jpg' })
  @IsString()
  filePath: string;
...
export class UpdateFarmTourImageDto {
  @ApiPropertyOptional({ description: '替代文字' })
  @IsString()
  @IsOptional()
  altText?: string;
...
export class ReorderFarmTourImagesDto {
  @ApiProperty({
...
export class GetFarmTourUploadUrlDto {
  @ApiProperty({ description: '檔案名稱', example: 'farm-tour-photo.jpg' })
  @IsString()
  fileName: string;
